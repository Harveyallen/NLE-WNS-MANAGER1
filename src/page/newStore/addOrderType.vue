<template>
  <mdoel-form>
    <el-form slot="left" label-width="120px">
      ...
      <el-form-item label="出库单分类名称" :class="$style.avatar_uploader">
        <el-input v-model="form.name" size="small"></el-input>
      </el-form-item>
      <el-form-item label="部分发货">
      ...
      <el-form-item label="指定出货区" :class="$style.avatar_uploader">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      $http.addOrderType(this.form, this.batchTypeId).then(() => {
